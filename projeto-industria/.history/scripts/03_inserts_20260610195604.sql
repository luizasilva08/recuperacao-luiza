...
VALUES
('2025-01-08', 'Tablet Industrial com tela quebrada', 'ALTA', 'FECHADO', '2025-01-15', 1, 3),
('2025-03-03', 'Coletor de dado RFID não funcionando', 'MÉDIA', 'FECHADO', '2025-03-24', 4, 4),
('2026-05-29', 'Switch sem conexão com a rede', 'ALTA', 'ABERTO', NULL, 5, 5),
('2025-09-07', 'Computador com problema no HD', 'ALTA', 'FECHADO', '2025-09-12', 5, 5),
('2026-06-10', 'Impressora não devolve o papel', 'BAIXA', 'ABERTO', NULL, 7, 2);

INSERT INTO Manutencao (data_manutencao, descricao_manutencao, )
