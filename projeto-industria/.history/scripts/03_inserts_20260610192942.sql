...
('Bruno', '12345678904', 'Bruno@techfactory', 'Chefe', '2023-11-13', 2 ),
('Cleiton', '12345678905', 'Cleiton@techfactory', 'Supervisor', '2023-05-02', 2 );
...
VALUES
('Note Tech', '098765432100', '47911111111', 'São Paulo' ),
('Servix', '987654321001', '47922222222', 'Curitiba' ),
('Colector MZ', '876543210012', '47933333333', 'São Paulo' ),
('Impril S.A.', '765432100123', '47944444444', 'Rio de Janeiro' ),
('SW Industry', '654321001234', '47955555555', 'Belo Horizonte' );

INSERT INTO Equipamento (patrimonio_equipamento, descricao_equipamento, fabricante_equipamento, modelo_equipamento, data_aquisicao)