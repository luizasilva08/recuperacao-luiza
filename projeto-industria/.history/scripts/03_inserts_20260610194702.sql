...
('234567891', 'Impressora', 'Impressora branca com cartucho de tinta', 'HP', 'Prime', '2020-05-12', 'MAU ESTADO', 3, 4, 7),
('345678912', 'Tablet Industrial', 'Tablet utilizado na fábrica', 'Samsung', 'A15', '2023-07-07', 'BOM ESTADO', 4, 1, 1),
('456789123', 'Coletor de Dados', 'Máquina coletora de dados RFID', 'Colector MZ', 'TAG', '2026-02-18', 'BOM ESTADO', 4,3,4),
('567891234', 'Switch', 'Switch com 10 portas', 'Cisco', '2.0', '2020-05-12', 'MAU ESTADO', 2, 5, 5);

INSERT INTO Chamado (data_abertura, descricao_problema, prioridade_chamado, status_chamado, data_encerramento, id_colaborador, id_equipamento)