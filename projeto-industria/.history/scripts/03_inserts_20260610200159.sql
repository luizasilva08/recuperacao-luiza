...
('SW Industry', '654321001234', NULL, 'Belo Horizonte' ); -- 5
...
VALUES
('2025-01-08', 'Tablet Industrial com tela quebrada', 'ALTA', 'FECHADO', '2025-01-10', 1, 3), -- 1
...
('2026-06-10', 'Impressora não devolve o papel', 'BAIXA', 'ABERTO', NULL, 7, 2); -- 5

INSERT INTO Manutencao (data_manutencao, descricao_manutencao, tempo_manutencao,
custo_manutencao, id_chamado)
VALUES
('2025-01-09', 'Troca da tela do Tablet', '48:00:00', '80.00', 1),
('2025-03-04', 'Troca do coletor de dados', '200:00:00', '300.00', 2),
('2025-09-08', 'Troca do HD', '156:00:00', '150.00', 4);
